...
seoTitle: "Crawleo for GitHub Copilot - Web Search in VS Code"
description: "Connect Crawleo to GitHub Copilot in VS Code using MCP. Enhance GitHub Copilot with real-time web search, live API documentation, and URL crawling for better code generation and development assistance."
icon: "github"
---
