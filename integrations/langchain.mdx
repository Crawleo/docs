...
seoTitle: "Crawleo LangChain Integration - Web Search for LLMs"
description: "Integrate Crawleo with LangChain to add real-time web search and crawling to your LLM applications. Perfect for building RAG systems, research agents, and AI assistants with live web data."
icon: "link"
---
...
| `screenshot` | bool | Capture screenshot (requires render_js=true) |
